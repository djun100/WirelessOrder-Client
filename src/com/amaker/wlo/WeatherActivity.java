...
import com.amaker.wlo.util.CurrentCondition;
import com.amaker.wlo.util.ForecastCondition;
import com.amaker.wlo.util.OrderStringUtil;
import com.amaker.wlo.util.OrderUrlUtil;
import com.amaker.wlo.util.OrderWeatherHandler;
       ...
       findAllView();
		...
		weatherQuery.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				proDlg = OrderStringUtil.createProgressDialog(WeatherActivity.this, getResources().getString(R.string.pro_title),
