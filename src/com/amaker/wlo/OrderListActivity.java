...
public class OrderListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		queryMenu.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				findViewById(R.id.order_title_image).setVisibility(View.GONE);
		...
		((Button)findViewById(R.id.go_list_menu_btn)).setOnClickListener(new Button.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent i = new Intent(OrderListActivity.this, LoginActivity.class);
				OrderStringUtil.putDataIntoIntent(i, str);
				startActivity(i);
			}
		});
